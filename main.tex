...
\begin{document}
	...
	Se la fase di analisi vuole sincerarsi di "che cosa" sviluppare, nella parte di progettazione ci si chiede "come" svilupparlo, dunque si ha una sorta di ponte fra analisi e codifica.
	\subsection{Modalità}
